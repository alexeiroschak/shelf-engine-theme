<?php
/*
 Template Name: About Template Version 2
 */
...
<div class="sh-about-page">
    ...
    <div class="sh-about-page__header">
        <div class="container">
            ...
            <h1 class="sh-about-page__header-title"><?php echo esc_html($head_title) ?></h1>
            <div class="sh-about-page__header-description"><?php echo wp_kses_post($head_description) ?></div>
        </div>
    </div>
    ...
    $prin_left_img = get_field('prin_left_image') ? get_field('prin_left_image') : esc_url(get_template_directory_uri() . '/img/about-bg-2.png');
    ...
    ?>
    <div class="sh-about-page__principles">
        <div class="sh-about-page__principles-icon-rt">
            <img src="<?php echo $prin_right_img; ?>" alt="">
        </div>
        <div class="sh-about-page__principles-icon-lb">
        ...
        <div class="sh-about-page-container container">
            <div class="sh-about-page-row">
                <div class="sh-about-page-col-6 sh-about-page-order-1">
                    ...
                    <div class="sh-about-page__story-description">
