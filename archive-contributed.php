    ...
    <div class="sh-press-page__wrap">
        <div class="sh-press-page__header">
            ...
            <div class="sh-press-page__menu">
                <a href="<?php echo get_post_type_archive_link('contributed') ?>" class="active">Press releases</a>
                <?php if ( ! empty( $terms ) ): ?>
                ...
                <div class="sh-resources__select sh-press-page__menu-select">
                    <select class="js-press-page-menu">
                        <option value="<?php echo get_post_type_archive_link('contributed') ?>"
                                selected="selected">
                            <?php esc_html_e('Press releases', 'sh'); ?>
                        </option>
                        <?php if ( ! empty( $terms ) ): ?>
                            <?php foreach ($terms as $term): ?>
                                <option value="<?php echo get_category_link($term->term_id); ?>">
        ...
        <div class="sh-contributed">
            <div class="sh-contributed__icon sh-contributed__icon-right-top">
                <img src="<?php echo esc_url($contributed_icon['right_top']['url']) ?>" alt="">
            </div>
            <div class="sh-contributed__icon sh-contributed__icon-left-center">
                <img src="<?php echo esc_url($contributed_icon['left_center']['url']) ?>" alt="">
            </div>
