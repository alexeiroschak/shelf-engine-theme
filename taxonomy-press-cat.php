            ...
            <div class="sh-press-mentions">
                ...
                <?php if ( $wp_query->max_num_pages > 1 ): ?>
                    <button class="sh-press-page__btn js-press-page-btn"
                        ...
                        data-max-pages="<?php echo esc_attr($wp_query->max_num_pages) ?>">Load more</button>
                <?php endif ?>
            </div>
        </div>
